...
For GPU versions, use src/processing/entities/disambiguation_processor.py
"""
...
class FAISSBlocker:
    ...
    **NOTE**: This is the CPU-only version for local development.
    ...
    def __init__(self, embedding_dim: int = 1024, M: int = 32):
        ...
        logger.info("For GPU version, use src/processing/entities/disambiguation_processor.py")
...
class SameJudge:
    ...
    def __init__(self, 
        ...
        logger.info("For GPU version with 8 workers, use src/processing/entities/disambiguation_processor.py")
